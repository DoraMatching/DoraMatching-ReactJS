        ...
        <div className={styles.postCard}>
            <div className={styles.postHeader}>
                ...
                <div className={styles.postThumb}>
                    <figure className={styles.postThumbImage}>
                        <img src={'/static/iconBlog.png'} alt="iconBlog" style={{ width: '30px' }} />
                    </figure>
            ...
            <div className={styles.postImage}>
                <img src={post.featuredImage} alt="imageBlog" style={{ width: '100%' }} />
            </div>
            <div className={styles.postContent}>
                ...
                <div className={styles.postMeta}>
                    <div className="extra content">
                        <div className="ui right labeled button" data-variation="tiny" tabIndex="0">
