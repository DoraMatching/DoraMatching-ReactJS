...
function CardProfileLeft({ userAcc }) {
    ...
    const getData = async () => {
        ...
        const { data: currentUserItem } = await Client(`${role}?userId=${userAcc.id} `, 'GET');
        ...
        <div>
            <div className={styles.cardProfileLeftWrapper}>
                ...
                <div className={styles.profile}>
                    <img src={userAcc.avatarUrl} alt="avatar" className={styles.thumbnail} />
                ...
                <div className={styles.socialIcons}>
                    ...
                    <div className={styles.icon}>
                        <h4>
                            {' '}
                            {classesTrainer && classesTrainer.classes
                                ? classesTrainer.classes.length
                                : 0}{' '}
                        </h4>
                        <p>Classes</p>
                    </div>
